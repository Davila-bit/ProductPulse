...
ThemeData getCatppuccinMochaTheme() {
  return ThemeData(
    useMaterial3: true,
    ...
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: CatppuccinMocha.surface1,
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8),
        borderSide: BorderSide(color: CatppuccinMocha.overlay0),
      ),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(8),
        borderSide: BorderSide(color: CatppuccinMocha.mauve, width: 2),
      ),
      labelStyle: TextStyle(color: CatppuccinMocha.text),
    ...
    textTheme: TextTheme(
      ...
      titleSmall: TextStyle(color: CatppuccinMocha.text),
      bodyLarge: TextStyle(color: CatppuccinMocha.text),
      bodyMedium: TextStyle(color: CatppuccinMocha.text),
      bodySmall: TextStyle(color: CatppuccinMocha.subtext1),
      labelLarge: TextStyle(color: CatppuccinMocha.text),
      labelMedium: TextStyle(color: CatppuccinMocha.text),
